...
#Mammal BM data 
Mam_BM <- read.csv("Mammal_SSD_BM_grids_75000.csv", header = TRUE, stringsAsFactors = FALSE)
str(Mam_BM)
...
#Mammal HBL data 
Mam_HBL <- read.csv("Mammal_SSD_HBL_grids_75000.csv", header = TRUE, stringsAsFactors = FALSE)
str(Mam_HBL)
...
ggplot(data = Microtus_oregoni_data_BM, aes(x = log(Mean_female_BM), y = log(Mean_male_BM))) + 
  coord_fixed(ratio = 1, xlim = c(2.8,3.2), ylim = c(2.8,3.2), expand = TRUE) +
  geom_point(aes(color=id_cells)) +
  geom_smooth(method = "lm", se = TRUE) +
  geom_abline(slope=1,intercept = 0, linetype="dashed")
...
ggplot(data = Microtus_townsendii_data_BM, aes(x = log(Mean_female_BM), y = log(Mean_male_BM))) + 
  coord_fixed(ratio = 1, xlim = c(3.75,4.4), ylim = c(3.75,4.4), expand = TRUE) +
  geom_point(aes(color=id_cells)) +
  geom_smooth(method = "lm", se = TRUE) +
  geom_abline(slope=1,intercept = 0, linetype="dashed")
...
ggplot(data = Microtus_townsendii_data_HBL, aes(x = log(Mean_female_HBL), y = log(Mean_male_HBL))) + 
  coord_fixed(ratio = 1, xlim = c(4.8,4.99), ylim = c(4.8,4.99), expand = TRUE) +
  geom_point(aes(color=id_cells)) +
  geom_smooth(method = "lm", se = TRUE) +
  geom_abline(slope=1,intercept = 0, linetype="dashed")
