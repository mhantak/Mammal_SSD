...
#Mammal BM data 
Mam_BM <- read.csv("Mammal_SSD_BM_grids_150000.csv", header = TRUE, stringsAsFactors = FALSE)
str(Mam_BM)
...
#Mammal HBL data 
Mam_HBL <- read.csv("Mammal_SSD_HBL_grids_150000.csv", header = TRUE, stringsAsFactors = FALSE)
str(Mam_HBL)
